EnemySkeleton = function (index, game, player, bullets, x, y) {   
...
var enemy1Spawns = [[200,300],[100,200],[500,600],[800,750],[900,400],[1800,400],[1600,1000],[1800,400],[1200,900],[1900,300],[1000,900],[300,1200],[1900,400],[500,500],[800,700],[500,900],[450,670],[200,100],[600,300],[750,800]] //20
function create() {
   ...
   // sprite.body.allowGravity = false;
    ...
    {
        enemies.push(new EnemySkeleton(i, game, sprite, enemyBullets, enemy1Spawns[i][0], enemy1Spawns[i][1]));        
    }
...
function menu(restart) {
    ...
    var menu = graphics.drawRect(100, 150, 600, 400);
    menu.inputEnabled = true;
    if (restart) {
        var txt = game.add.text(250, 250, "You died! Your score was "+score+"\nClick to try again!");
        ...
        var txt = game.add.text(250, 250, "Welcome to Ludum!\n WASD keys to move/aim \nSPACE to fire \nSHIFT to activate shield \nClick to Begin!"); 
        menu.events.onInputUp.add(function () {
            game.paused = false;
            menu.kill();
        }); 
